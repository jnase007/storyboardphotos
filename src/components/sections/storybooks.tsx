...
const ADVENTURES = [
  {
    ...
    description: "Climb the Ember Path, face fire-gusts, and free Dragon Land. Joshua 1:9",
  ...
  },
  {
    ...
    description: "Cross a shattered bridge and pull friends off the cliff path. Luke 15:4",
  ...
  },
  {
    ...
    label: "Scale the Cliffs",
    description: "Climb the White Cliffs and reclaim the lost crown. Proverbs 4:23",
  ...
  },
  {
    ...
    label: "Free the River",
    description: "Race the storm, free the jammed river, save the trees. Genesis 2:15",
    image: "https://cpnnztrqgbxledbikpqt.supabase.co/storage/v1/object/public/story-scenes/adventure-cards/forest-guardian.jpg",
    color: "#10b981",
  },
  {
    id: "kindness-quest",
    title: "Midnight Lantern Run",
    label: "Beat Midnight",
    description: "Village goes dark — race supplies across a broken bridge before midnight. Ephesians 4:32",
  ...
  },
  {
    ...
    description: "Vines, tunnels, traps, final leap — find the chest and share it. Matthew 5:14",
