...
const ADVENTURES = [
  {
    ...
    description: "Face the great dragon with courage — and discover that bravery and kindness can turn a foe into a friend. Joshua 1:9",
  ...
  },
  {
    ...
    label: "Save the Day",
    description: "Race through the kingdom to rescue friends and bring them safely home. Luke 15:4",
  ...
  },
  {
    ...
    description: "Follow the clues across the kingdom and return the crown with a true heart. Proverbs 4:23",
  ...
  },
  {
    ...
    description: "Care for God's green world and restore light to the trees. Genesis 2:15",
  ...
  },
  {
    ...
    description: "Journey through the village spreading kindness and light to everyone you meet. Ephesians 4:32",
